...
{
    instruction_t instr[] = {
        {"pall", pall}, {"add", _add}, {"sub", _sub}, {"div", _div}, {"mul", _mul}, {"mod", _mod}, {"pint", pint}, {"pchar", pchar}, {"pop", pop}, {"rotl", rotl}, {"rotr", rotr}, {"stack", stack}, {"queue", queue}, {"nop", nop}, {"swap", swap}, {"pstr", pstr}, {NULL, NULL}};
    int i, push_return;
    char *start_c;
